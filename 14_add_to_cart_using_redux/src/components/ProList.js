...
export default function ProList(props) {
  ...
  <img src={props.product.image} className="card-img-top" alt="..." width={200} height={200 }/>
  <div className="card-body">
    <h5 className="card-title">{props.product.pname}</h5>
    <p className="card-text">Price : Rs.{props.product.price}</p>
    <a href="#" className="btn btn-primary" onClick={()=> addCart(props.product.id)}>Add to Cart</a>
  </div>
</div>
  )
}
